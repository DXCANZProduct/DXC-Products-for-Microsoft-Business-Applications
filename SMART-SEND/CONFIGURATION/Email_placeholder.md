...
|  **Sales Order Confirmation**  | Confirmation Id: %ConfirmationId% <br/> Sales Id: %SalesId% <br/> Invoice Account: %InvoiceAccount% <br/> Delivery Name: %DeliveryName% <br/> Confirmation Date: %ConfirmDate% <br/> Purchase Order: %PurchaseOrder% <br/> Created Date: %CreatedDate% <br/> Customer Name: %CustomerName%| 
