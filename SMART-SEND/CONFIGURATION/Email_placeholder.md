...
|  **Company Logo**  |  By inserting a picture from an online storage source, such as Sharepoint or Blob Stoarge, into a placeholder command, the company logo can be included in an organisational email template. Note: FinOps cannot access the image without appropriate permissions, sometimes known as "anonymous" access. Put your URL in <img src="URL"width="50" height="50" alt="logoImage"/> to establish your placeholder, where "URL" is the location of your image. The width and height numbers at the end of the plcaeholder string can be increased to change the image's size. If the template has been made using the proper HTML structure, the image will appear inside organisational email templates.
