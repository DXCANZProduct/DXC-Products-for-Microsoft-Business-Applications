...
- Bank statement reconciliation - **Offset account reference bank statement** field is set to use a field from the bank statement field to find the applicable D365 customer account - [More info](../CASH-AND-BANK-MANAGEMENT/Bank-reconciliation-matching-rules#customer-payment-and-settle-of-invoice-11)
