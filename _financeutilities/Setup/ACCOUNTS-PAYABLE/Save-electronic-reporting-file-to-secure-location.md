...
-	Step 1: Setup [Electronic reporting export connection](../ELECTRONIC-REPORTING-EXPORT/Electronic-reporting-export-connections)
-	Step 2: Setup [Document types](../ELECTRONIC-REPORTING-EXPORT/Document-types), using Step 1’s Connection
-	Step 3: Setup [Electronic reporting destination](../ELECTRONIC-REPORTING-EXPORT/Electronic-reporting-destination), using Step 2’s Document type
...
## Processing
Vendor payment processing using the above method of payment is discussed at [Processing](../../Processing/Accounts-Payable/Save-electronic-reporting-file-to-secure-location)
