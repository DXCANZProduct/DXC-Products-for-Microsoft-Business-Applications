...
1. Create the secure location in [Electronic reporting export connections](../Setup/Electronic-reporting-export-connections)
2. Assign to secure location created in step 1 to applicable [Document types](../Setup/Document-types)
3. Create the [Electronic reporting destination](../Setup/Electronic-reporting-destination) for the applicable Electronic reporting configuration and assign the Document type created in step 2
