...
> Note: Setup the [**Payment advice**](../../Setup/ACCOUNTS-PAYABLE/Vendor-payments#payment-advice-report) report to use the applicable Finance utilities report.
