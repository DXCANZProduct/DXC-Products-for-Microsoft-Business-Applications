...
The **Methods of payment** is assigned in the Periodic task called [Payment journal import](Customer-remittance.html#periodic-task).

Also see:
- [Setup](Customer-remittance.html)
- [Processing](../Processing/Customer-remittance.html)
