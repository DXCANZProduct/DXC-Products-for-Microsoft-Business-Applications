...
Setup requirements are discussed in detail at [Vendor payments setup](../../Setup/ACCOUNTS-PAYABLE/Vendor-payments). <br>
...
- **Lodgement reference** - [BPAY payment](BPAY-payment)
- **Sundry invoice details** - [Sundry payment](Sundry-payment)
  - Sundry vendor name
  - Sundry address
...
- **Payment reference** - [Setup](../../Setup/ACCOUNTS-PAYABLE/Vendor-payments#automatic-generation-of-payment-reference)
- **Export file name** - Export file name displayed on the Generate payments dialog is written to the relevant vendor payment journal lines
     ...
     - [File name setup](../../Setup/ACCOUNTS-PAYABLE/Vendor-payments#eft-file-name-generation)
...
[More details](Save-electronic-reporting-file-to-secure-location)
