...
Setup requirements are discussed in detail at [Vendor payments setup](../Setup/Vendor-payments). <br>
...
- **Payment reference** - [Setup](../Setup/Vendor-payments#automatic-generation-of-payment-reference)
- **Export file name** - Export file name displayed on the Generate payments dialog is written to the relevant vendor payment journal lines
     ...
     - [File name setup](../Setup/Vendor-payments#eft-file-name-generation)
