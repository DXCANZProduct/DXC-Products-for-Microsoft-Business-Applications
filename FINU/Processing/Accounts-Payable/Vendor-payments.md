...
- **Payment reference** - [Setup](../../Setup/Accounts-Payable/Vendor-payments.html#automatic-generation-of-payment-reference)
- **Export file name** - Export file name displayed on the Generate payments dialog is written to the relevant vendor payment journal lines
     ...
     - [File name setup](../../Setup/Accounts-Payable/Vendor-payments.html#eft-file-name-generation)
