...
description: [Finance Utilities  -Example file format]
author: [helenho]
manager: Kym Parker
ms.date: 02/03/2021
ms.topic: article
...
The image below is an example of a budget file to be imported.  The file must be .CSV format.
