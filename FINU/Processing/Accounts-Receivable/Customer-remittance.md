...
- Options per methods of payment: 
    ...
    - Settle transaction. When set to _Yes_, the functionality will attempt to settle the payment line against an open invoice. Also see prepayment options per legal entity **
