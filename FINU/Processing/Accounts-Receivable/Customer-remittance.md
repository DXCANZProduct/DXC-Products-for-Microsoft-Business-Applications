...
**Account**         | Calculated by either of the following methods: <br> • Import file's mapped field **Reference number** <br> • Import file's mapped field **Invoice** <br> • Method of payment's **Error account customer**
