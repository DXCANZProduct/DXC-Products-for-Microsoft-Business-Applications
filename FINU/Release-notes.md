...
N/A		| License manager	| License manager version 10.8.32.10171 <br> Required changes to transition License Manager to a SaaS offering <br> Introducing allowing multiple ISV vendors to manage products through the License manager, see publisher in the product license overview table. <br> ![System parameters](Images/ReleaseNotes_202304_2.png "System parameters")
