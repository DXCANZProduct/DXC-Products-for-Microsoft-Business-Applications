...
:--       	|:--     	|:--	         	|:--
17513		| Cash and bank management	| Modern bank reconciliation	| Support for feature **Modern bank reconciliation**. <br> This release will exclude Reconciliation matching rules Data entity, as the std entity doesn't support Modern bank reconciliation yet - dependent on MS. <br> [Setup](Setup/CASH-AND-BANK-MANAGEMENT/Modern-bank-reconciliation.md) <br> [Processing](Processing/Bank-Statement-Reconciliation/Modern-bank-reconciliation.md)
