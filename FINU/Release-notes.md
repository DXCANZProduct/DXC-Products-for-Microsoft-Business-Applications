...
17286		| Accounts payable	| ABN validation | _Only applicable to Australia and only visible where ABN validation is enabled for the Legal entity_ <br> Ability to view **ABN status** when invoicing vendor. <br> **ABN status** button is enabled when the 'Tax exempt number'/'ABN' is populated for the invoice line. <br> ![Vendor invoice ABN status](Images/ReleaseNotes_20240329_7.png "Vendor invoice ABN status") 
