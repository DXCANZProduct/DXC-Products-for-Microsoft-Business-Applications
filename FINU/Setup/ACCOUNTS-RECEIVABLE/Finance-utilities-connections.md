...
**Connection string**     |	Enabled when Credential type = **Key vault**. <br> Select the applicable **Secret** as setup in **Key vault paramaters**. <br> **Azure SAS Storage account level tokens** also supported. 
