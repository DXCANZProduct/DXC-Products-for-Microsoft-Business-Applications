...
### 3.1.3.	Populate Accounts Payable Payment Document Number 
...
- <b> Cash and bank management > Setup > Cash and bank management parameters - Bank reconciliation – Turn off reconciliation worksheet performance enhancements – set to Yes. </b>
- <b> Accounts Payable > Setup > Accounts payable parameters </b> – Number sequences - set the Payment reference number sequence.
