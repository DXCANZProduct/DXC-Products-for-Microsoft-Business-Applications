...
The below fields have been added to the existing Vendor approval fields. When enabled they will be submitted using the existing <b> Proposed vendor changes workflow. </b>

<b> Vendor bank account: </b>
-	Bank groups
-	BSB number
-	Bank account number
-	SWIFT code
