...
A list of installed models will be displayed on the **Version** tab.  Scroll to **DXC Agent For FSCM**. The version information will be displayed on the right (i.e. DXC Agent For FSCM **10.0.45.20260227** (isv))
