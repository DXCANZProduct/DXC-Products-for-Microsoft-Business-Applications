...
![Matching justification](../IMAGES/agent-bankrecon-matched-voucher.png)
...
- **Vouchers created by agent** - Count of vouchers created by agent for the bank reconciliation
