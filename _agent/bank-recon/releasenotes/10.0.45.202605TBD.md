...
25650      | **Generate voucher**            | New license / feature called **DXC Agent for bank reconciliation voucher generation**. Ability to create a new voucher transaction based on history. <br> [Setup]({{ '/agent/bank-recon/setup/voucher' | relative_url }})
