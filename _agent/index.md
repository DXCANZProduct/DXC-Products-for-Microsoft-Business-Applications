...
header: DXC Agents for D365 FSCM
toc: true
---

# Introduction

DXC Agents for D365 FSCM utilises **Microsoft Foundry** which is a code‑first and studio experience for building scalable AI applications and agents with complete control of models, prompts, tools, and data.
