...
# Business Process Links _Deprecated_
...
3. Hover mouse over _Form information_ to view the exact form name.
   - Selecting _Form name_ will open the _Form information_ slider, the form name can be copied from within the Administration tab.
...
The _Maintain process links table_ security role has access to edit the Process Links form.
...
2. Click on _DXC business process_ tab and select _SharePoint_ from the _Connector type_ drop down select list under the _Connector type_ fast tab. This action will display fields applicable for SharePoint search setup.
...
3. Connector type
   - Select _Mavim portal_ in the connector type field. This action will display the fields required to configure Mavim portal search setup.
...
3. Select the _Processes_ tab.
4. Results will display with a hyperlink.

_Note: These are hyperlinks that are independent of Finance and Operations, some systems may require credentials to be specified._
