...
| **Cash flow forecast** | No            | If this budget record is to be included in the cash flow forecast enter _Yes_, otherwise _No_.                                                                                                                                                                                                                                                                                     |
| **GST group**          | No            | The relevant GST group relating to the budget record. Typically, this would be left blank.                                                                                                                                                                                                                                                                                         |
| **Account Structure**  | Yes           | The account structure to use to resolve the main account. Sourced from _General ledger>Chart of accounts>Structures>Configure account structures_                                                                                                                                                                                                                                  |
...
_Note: Columns will be expanded for each Dimension and Date._
