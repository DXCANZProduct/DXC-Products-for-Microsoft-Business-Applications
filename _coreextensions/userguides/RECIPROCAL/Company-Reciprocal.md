...
For example, instead of showing 0.69, it displays a result of 1/0.69 relevant to the _home_ currency set for the legal entity. <br>
...
3. The exchange rate is displayed per line as part of the Journal and also under the _General_ tab

- <ins>Vendor invoice journal lines<ins>

1. Navigate to **Accounts payable > Invoices > Tax invoice journal**
2. Select the required Journal from the list.
3. View the exchange rate fields per line under the _General_ tab
...
2. Click **Purchase** from the Action Pane and select _Totals_ under the **View** tab (on the Action Pane)
3. The _Exchange rate_ field is located under the _Purchase order totals_ fast tab located in Pane on the right of the screen
...
2. Select _Totals_ from the Action pane to display the Totals Pane. The exchange rate is located at the bottom including the respective currency code

- <ins>Sales order totals<ins>

1. Navigate to **Accounts receivable > orders > All sales orders**
2. Click **Sales order** from the Action Pane and select _Totals_ under the **View** tab (on the Action Pane)
3. The _Exchange rate_ field is located under the _Sales order totals_ fast tab located in Pane on the right of the screen
