...
:--       	|:--              |:--
24425|Billing Journal should search and populate Vendor account when processing client refund  for customer account|billing journal should populated the "vendro" account for a customer
24391|Client refund proposal function is  greyed out  for type organization|allow client refund prpocess to be initated for customer type organization
24424|GST duplication on Reversal transaction part of the Billing adjustment proposal|GST duplication on Reversal transaction part of the Billing adjustment proposal
...
23187|Modifications to Service Entries|Additional fields added to Service entries to manage depature of resident villages
