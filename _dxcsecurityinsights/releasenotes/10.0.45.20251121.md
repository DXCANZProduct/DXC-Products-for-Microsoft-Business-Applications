...
### Release 10.0.45.20251121

#### Build 10.0.45.202511216
...
:--	  	|:--	   	 |:--
24579   | Duplicate user  | Duplicate display of user in **Security insights by user** form where the user is linked to a person that is only a worker.
