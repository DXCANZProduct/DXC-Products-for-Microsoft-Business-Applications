...
_Note: Attempting to update a status to a value that has not been defined as an allowed status transition will return an error preventing the action from being completed._
