...
**Standard date and time format** |	Enabled when ‘Date and time format’ = Standard. [Options](https://docs.microsoft.com/en-us/dotnet/standard/base-types/standard-date-and-time-format-strings)
