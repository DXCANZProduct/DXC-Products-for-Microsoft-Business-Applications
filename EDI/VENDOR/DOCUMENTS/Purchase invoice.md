...
:---------------------- |:----                   |:----
Item not found: %	                  | Item not found         | **EDI > Documents > Vendor documents > Purchase invoice** and/or <br> **Product information management > Products > Released products**. <br> Dependening on **Item Id source** assigned to Trading partner’s Document's [Setting profile](../SETUP/SETTING%20PROFILES/Purchase%20invoice.md), EDI couldn’t find the staging record's Item Id / Barcode. <br> Either fix staging or setup on the Item.
