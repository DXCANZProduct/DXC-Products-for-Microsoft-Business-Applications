...
Example errors and possible fixes are discussed in [FAQ](../OTHER/FAQ.md#shipment-receipt---return-order).

### Validation

[Validation profiles](../SETUP/VALIDATION%20PROFILES/Shipment%20receipt%20-%20Return%20order.md) can be specified and linked to the template along with a rule error tolerance which is used to determine how D365 will react.  Options are:
