...
ms.search.form:  SAB_EDI3PLWHSInventStatusMapping, SAB_EDIStagingFormRun_StockTransferReceipt_PO, WMSJournalName
...
Example errors and possible fixes are discussed in [FAQ](../INTRODUCTION/FAQ.md#shipment-receipt-purchase-order).
