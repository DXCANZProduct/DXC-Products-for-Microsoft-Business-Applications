...
ms.search.form:  SAB_EDIStagingFormRun_StockTransferReceipt_TO, SAB_EDIDocumentTypeTable, SAB_EDIFileImport
...
4. Create [Setting profile](../SETUP/SETTING-PROFILES/Shipment-receipt-Transfer-order.md) for the document.
5. Create [Validation profile](../SETUP/VALIDATION-PROFILES/Shipment-receipt-Transfer-order.md) for the document.

### Trading partners
EDI > Setup > Trading partners
3. If the warehouse [trading partner](../SETUP/Trading-partner.md) doesn't exist, create the new trading partner.
...
5. Add and enable the **Shipment receipt - Transfer order** document to the [Warehouse trading partner](../SETUP/Trading-partner.md) and select the applicable:
    - Template
    - Setting profile
    - Validation profile
    - Search mask
...
Example errors and possible fixes are discussed in [FAQ](../INTRODUCTION/FAQ.md#shipment-receipt-transfer-order).

### Validation

[Validation profiles](../SETUP/VALIDATION-PROFILES/Shipment-receipt-Transfer-order.md) can be specified and linked to the template along with a rule error tolerance which is used to determine how D365 will react.  Options are:
...
<ins>**Overview**</ins>		|
**Transfer number**         | Transfer order number being received	            | Used to find D365 source transaction
**Receipt date**            | Date the stock was received. If setting Auto receive is enabled, this will also be used in posting the transfer order's receipt date.	| • Arrival journal > Posted on <br> • Trasnfer order > Receipt date
...
**Lot Id**                  | Lot id for the transfer order line                                        | Used to find D365 source transaction line
