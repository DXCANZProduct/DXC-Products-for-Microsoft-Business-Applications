...
Item not found	    | **EDI > Documents > Customer documents > Customer purchase order** and/or **Product information management > Products > Released products** <br>
Dependening on Item Id source assigned to Trading partner’s Document [**Setting profile**](../SETUP/SETTING%20PROFILES/Customer%20purchase%20order.md), EDI couldn’t find the staging record's Item Id / Barcode. Either fix staging or setup on the Item.
