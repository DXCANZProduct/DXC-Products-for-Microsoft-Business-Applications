...
**Item number**             | The item identifier as sent by the trading partner. 	| Sales line > EDI > General > EDI Item number <br> Used when document type setting **Item Id source**** is: <br> • **Our item number** or <br> • **External item number** is to determine Sales line > Item number
**Bar code**                | The item identifier as sent by the trading partner. 	| Used when document type setting **Item Id source** is: <br> • **GTIN** or • **Barcode** to determine: Sales line > Item number
**SKU**                     | SKU for item	
