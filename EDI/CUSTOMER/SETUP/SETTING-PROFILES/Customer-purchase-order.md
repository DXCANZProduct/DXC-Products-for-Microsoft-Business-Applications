...
**Blank unit**    | Where the staging record will create a new sales line and the **Unit** is not provided in the file, this document setting provides options to use one of the options for the blank unit line(s) |  • Sales unit <br> • Sales trade agreement unit <br> • Inventory unit <br> • Error (errors the complete staging record)
