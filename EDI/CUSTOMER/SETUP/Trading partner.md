...
**No Backorders**                 |	Identify if the trading partner accepts backorders. <br> Where the POA’s document setting Quantity type is set to Reserved quantity, the sales line’s ordered quantity is adjusted to the quantity reserved for the sales line. <Br> The setting is also used on the POA to identify full or partial shipments.
