...
**Template**                      |	Document type template		                                                                               | [EDI > Setup > Document types](../../CORE/Setup/Document%20types.md)
**Setting profile**               |	Settings profile		                                                                                     | [EDI > Setup > Document types](../../CORE/Setup/Document%20types.md)
...
**Template**                      |	Document type templates defined for the document type                                                    | [EDI > Setup > Document types](../../CORE/Setup/Document%20types.md)
**Setting profile**               |	Settings profiles defined for the document type                                                          | [EDI > Setup > Document types](../../CORE/Setup/Document%20types.md)
