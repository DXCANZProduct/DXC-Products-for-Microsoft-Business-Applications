...
:------------------------|:-------------------|:------------------------
Care Services Funding Journal Entry| Care Services>Journals>Funding journal| New entity for Funding journal<br/> Available Fields. <br> Refer to [Document Template]({{ 'careservices/OTHER/Document_template#care-services-funding-journal-entry' | relative_url }})
Care Services Billing Journal Line Entry V2| Care Services>Journals>Billing journal | Replaces Care Services Billing Journal Line Entry<br/> Available Fields <br> Refer to [Document Template]({{ 'careservices/OTHER/Document_template#care-services-billing-journal-line-entry-v2' | relative_url }})
Care Services Receipt Journal  Line Entry V2| Care Services>Journals>Receipt Journal| Replaces Care Services Receipt Journal Line Entry<br/> Available Fields <br> Refer to [Document Template]({{ 'careservices/OTHER/Document_template#care-services-receipt-journal--line-entry-v2' | relative_url }})
