...
-   Community Care Clients can transfer to respite or permanent care at an Aged Care  facility.
...
-   Partial refunds of accommodation payments are processed for movements to a room with a different price or as agreed with the resident
-   Full refunds are processed on departure or transfer to another facility.
-   Partial or full refunds can be processed for overpayments or incorrect charging as per standard consumer law. 
...
This process is used to reverse the full refund when a resident has departed from the service entry. The full refund has been generated, up to the point of the refund journal being posted to AP, but it has not yet been paid to the client or their estate.

As the Accommodation Payment has already been fully refunded and cannot be refunded again, there needs to be a new Accommodation payment header set up to enable the refund to be processed again later when it is ready
