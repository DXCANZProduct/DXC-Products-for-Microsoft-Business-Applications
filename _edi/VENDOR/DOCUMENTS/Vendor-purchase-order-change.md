...
2. Create [Order line change type group](../SETUP/VENDOR-SETUP/Order-line-change-type-group) - mapped to LineChangeType on the document.
3. Create [Carrier mode](../SETUP/VENDOR-SETUP/Carrier-mode) - mapped to CarrierMode on the document.
4. Create [Charges code](../SETUP/VENDOR-SETUP/Charges-code) - mapped to MiscCode on the document.
5. Create [Payment terms type group](../SETUP/VENDOR-SETUP/Payment-terms-type-group) - mapped to TermsTypeCode on the document.
6. Create [Misc charge/allowance indicator](../SETUP/VENDOR-SETUP/Misc-charge-allowance-indicator) - mapped to MiscIndicator on the document.
...
1. Add and enable the **Vendor purchase order change** document to the [Vendor trading partner](../SETUP/Trading-partner) and select the applicable:
    - Template
    - Setting profile
    - File name setup
