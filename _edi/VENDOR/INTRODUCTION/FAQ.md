...
# Frequently asked questions - Vendor
...
No mapping found for misc method of handling %  | Staging record's **Misc method of handling** isn't found in [Misc method of handling](../SETUP/VENDOR-SETUP/Misc-method-of-handling). Add to mapping if correct, else fix staging record.
