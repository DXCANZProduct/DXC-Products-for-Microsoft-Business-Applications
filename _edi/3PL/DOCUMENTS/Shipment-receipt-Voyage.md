...
1. Create [Setting profile](../SETUP/SETTING-PROFILES/Shipment-receipt-Voyage) for the document.
...
1. Add and enable the **Shipment receipt - Voyage** document to the [Warehouse trading partner](../SETUP/Trading-partner) and select the applicable:
    - Template
    - Setting profile
    - Search mask
...
Example errors and possible fixes are discussed in [FAQ](../INTRODUCTION/FAQ#shipment-receipt-voyage).
