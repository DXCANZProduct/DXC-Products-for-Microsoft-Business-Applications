...
4. Create [Setting profile](../SETUP/SETTING-PROFILES/Shipment-receipt-Transfer-order) for the document.
5. Create [Validation profile](../SETUP/VALIDATION-PROFILES/Shipment-receipt-Transfer-order) for the document.

### Trading partners
EDI > Setup > Trading partners
3. If the warehouse [trading partner](../SETUP/Trading-partner) doesn't exist, create the new trading partner.
...
5. Add and enable the **Shipment receipt - Transfer order** document to the [Warehouse trading partner](../SETUP/Trading-partner) and select the applicable:
    - Template
    - Setting profile
    - Validation profile
    - Search mask
...
Example errors and possible fixes are discussed in [FAQ](../INTRODUCTION/FAQ#shipment-receipt-transfer-order).

### Validation

[Validation profiles](../SETUP/VALIDATION-PROFILES/Shipment-receipt-Transfer-order) can be specified and linked to the template along with a rule error tolerance which is used to determine how D365 will react.  Options are:
