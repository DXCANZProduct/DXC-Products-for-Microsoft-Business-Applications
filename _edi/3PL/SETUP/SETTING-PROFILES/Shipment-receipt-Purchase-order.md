...
## Where used
The **Setting profile** can be assigned on the Incoming documents FastTab to document type [Shipment receipt - Purchase order](../../DOCUMENTS/Shipment-receipt-Purchase-order) for the 3PL Trading partner at **EDI > Setup > Trading partners**.
