...
## Where used
The **Setting profile** can be assigned on the Incoming documents FastTab to document type [Inventory adjustment advice - Movement](../../DOCUMENTS/Inventory-adjustment-Movement) for the 3PL Trading partner at **EDI > Setup > Trading partners**.
