...
## Where used
The **Setting profile** can be assigned on the Outgoing documents FastTab to document type [Shipment advice - Purchase order](../../DOCUMENTS/Shipment-advice-Purchase-order) for the 3PL Trading partner at **EDI > Setup > Trading partners**.
