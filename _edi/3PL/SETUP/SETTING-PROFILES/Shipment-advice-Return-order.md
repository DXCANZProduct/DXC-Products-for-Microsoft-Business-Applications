...
## Where used
The **Setting profile** can be assigned on the Outgoing documents FastTab to document type [Shipment advice - Return order](../../DOCUMENTS/Shipment-advice-Return-order) for the 3PL Trading partner at **EDI > Setup > Trading partners**.
