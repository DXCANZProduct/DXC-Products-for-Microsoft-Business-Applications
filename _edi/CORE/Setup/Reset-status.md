...
2.	Assign default **Reset profile** on [**EDI shared parameters**](EDI-shared-parameters) or set up on only the applicable Trading partner’s documents (step 3)
...
- [EDI shared parameters](EDI-shared-parameters):
