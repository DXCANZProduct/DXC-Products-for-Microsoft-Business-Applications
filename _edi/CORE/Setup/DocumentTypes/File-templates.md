...
- For outgoing documents, use **Skip segment if blank** to flag where if staging value is blank, it shouldn't send the segment. Example is 'Total charges' in SAC segment. Set flag to _Yes_ on applicable staging line. 
