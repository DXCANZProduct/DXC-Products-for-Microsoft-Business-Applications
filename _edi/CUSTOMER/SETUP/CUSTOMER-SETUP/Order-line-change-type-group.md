...
## Where used
Customer EDI order line change type group is assigned on the [Customer Trading partner's](../Trading-partner) Options field called **Order line change type group**.
