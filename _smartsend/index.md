...
#### Projects
*	Project quotation (see [parameters]({{ '/smartsend/CONFIGURATION/Parameters' | relative_url }}))
*	Project invoice
...
*Note: Major updates to the underlying Microsoft Dynamics 365 solution may require a new version of the add-on solution to remain compatible with Microsoft Dynamics 365. Best practices in extension-based development are used to maintain maximum compatibility with future versions of Microsoft Dynamics 365. Most incremental Microsoft Dynamics 365 updates should not require a new version of the add-on solution, but testing should always be performed before deploying to a production environment.*

## Configuration

The following setup is required to configure Smart Send:
- [Smart send parameters]({{ '/smartsend/CONFIGURATION/Parameters' | relative_url }}) - Configure the business form or report type to be sent using Smart Send.
- [Email templates]({{ '/smartsend/CONFIGURATION/Email-template' | relative_url }}) - Create an email template to add a body to the email being generated. Placeholder tokens allow for the values in the report to be dynamically created.
- [Email placeholders]({{ '/smartsend/CONFIGURATION/Email_placeholder' | relative_url }}) - Identify the fixed and dynamic tokens supported for each report type.
- [Contact information purposes]({{ '/smartsend/CONFIGURATION/Address-and-contact-information-purpose' | relative_url }}) - Create or identify an existing contact information purpose as the intended destination of the business form or report.
- [Contact information]({{ '/smartsend/CONFIGURATION/Contact-information' | relative_url }}) - Contact information with the appropriate purpose must be stored against the account or account contact.
- [Security]({{ '/smartsend/CONFIGURATION/Security' | relative_url }}) - Lists the privileges associated with Smart Send and the security roles with access to the privilege
- [Email processing]({{ '/smartsend/PROCESSES/Email-processing' | relative_url }}) - Configure print management or as required override functionality .
